...
\caption{Example of the tagged data representation used in the Steele an Sussman processor, intended to improve evaluation and lookup efficiency [5].}
...
\caption{An overview diagram of the processor design proposed by Steele and Sussman. This design was fabricated to test the author's proposed system, but was likely never implemented commercially [5].}
\label{Data representation}
\end{figure}
...
%[5] Design of Lisp-Based Processors by Steele and Sussman (PDF)
%[6] The Architectures of Lisp Machines by Plesz & Thaz (PDF)
