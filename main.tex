...
% "compressed/ranged". e.g., [1], [9], [2], [7], [SS], [PT] without using
% cite.sty will become [1], [2], [SS]--[7], [9] using cite.sty. cite.sty's
...
In March 1979, Steele and Sussman, researchers at the MIT AI Lab in the 1970s, outlined and discussed a processor that they suggested would allow for the efficient execution of Lisp programs under a dialect of Lisp they had created [SS]. While it is uncertain whether their ideas were directly implemented in an actual Lisp machine, they provide solutions to the environment maintenance and efficient list representation problems proposed by Pleszkun and Thazhuthaveetil, providing a great degree of detail in describing their implementation.
...
\caption{An overview diagram of the processor design proposed by Steele and Sussman. This design was fabricated to test the author's proposed system, but was likely never implemented commercially [SS].}
\label{Data representation}
\end{figure}
...
%[1] History of Lisp Machines by Stoyan (PDF)
%[2] Recursive Function... by McCarthy (PDF)
%[3]http://www.andromeda.com/people/ddyer/lisp/
%[4]Lisp Machines: Noble Experiment... by P. T. Withington (PDF)
%[SS] Design of Lisp-Based Processors by Steele and Sussman (PDF)
%[PT] The Architectures of Lisp Machines by Plesz & Thaz (PDF)
